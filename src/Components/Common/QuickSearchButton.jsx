...
const QuickSearchButton = () => {
  ...
  return (
    <>
      {/* دکمه جستجوی سریع ثابت - در همه صفحات و همه سایزها */}
      <button
        onClick={openModal}
        className="fixed bottom-20 right-4 sm:bottom-24 lg:bottom-6 lg:right-6 z-40 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-full p-3 sm:p-4 lg:p-4 shadow-2xl hover:shadow-blue-500/50 transition-all duration-300 hover:scale-110 group border-2 border-white/20"
        aria-label="جستجوی سریع"
        title="جستجوی سریع محصولات"
      >
        <SearchIcon className="text-xl sm:text-2xl lg:text-2xl group-hover:rotate-12 transition-transform duration-300" />
        
        {/* Tooltip - در همه سایزها */}
