...
const ReviewSection = ({ productId, reviews = [], onSubmitReview }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8">
      <h3 className="text-2xl font-bold text-gray-800 mb-6">نظرات و امتیازدهی</h3>
      ...
      <div className="border-b border-gray-200 pb-8 mb-8">
        <h4 className="text-lg font-semibold text-gray-800 mb-4">نظر خود را ثبت کنید</h4>
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-gray-500 text-sm mr-2">({rating}/5)</span>
        </div>
      ...
      {/* نمایش نظرات */}
      <div>
        <h4 className="text-lg font-semibold text-gray-800 mb-4">نظرات کاربران</h4>
        {reviews.length === 0 ? (
