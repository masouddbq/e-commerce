        ...
        {!isSubscribed ? (
          <>
            <div className="mb-8">
              ...
              <h2 className="text-3xl font-bold text-blue-600 mb-4">عضویت در خبرنامه ما</h2>
              ...
              <div className="flex items-center justify-center mb-6">
                <label className="flex items-center cursor-pointer">
                  ...
                  <span className="text-blue-700 text-sm">
                    با <a href="#" className="underline hover:text-blue-800">قوانین و مقررات</a> و <a href="#" className="underline hover:text-blue-800">حریم خصوصی</a> موافقم
                  </span>
                </label>
              </div>
          ...
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-blue-600 mb-2">عضویت موفقیت‌آمیز بود!</h2>
